...
from .models import C_User, Staffs, Courses, Subjects, Students, Attendance, AttendanceReport, LeaveReportStudent, FeedBackStudent, StudentResult
...
def student_view_attendance(request):
    try:
        student_obj = Students.objects.get(admin=request.user.id) # Getting Logged in Student Data
        #course = student_obj.course_id # Getting Course Enrolled of LoggedIn Student
        course = Courses.objects.get(id=Students.course_id) # Getting Course Enrolled of LoggedIn Student
    ...
    return render(request, "student_template/student_view_attendance.html", {'student_obj': student_obj})
...
def student_view_attendance_post(request):
    if request.method != "POST":
        ...
        user_obj = C_User.objects.get(id=request.user.id)
...
def student_profile_update(request):
    if request.method != "POST":
        ...
        try:
            ...
            student = Students.objects.get(admin=C_User.id)
