...
class AdminHOD(models.Model):
    id = models.AutoField(primary_key=True)
    admin = models.OneToOneField(C_User, on_delete = models.CASCADE)
...
class Subjects(models.Model):
    ...
    staff_id = models.ForeignKey(C_User, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    objects = models.Manager()
...
# It's like trigger in database. It will run only when Data is Added in C_User model

@receiver(post_save, sender=C_User)
