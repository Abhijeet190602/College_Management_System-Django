...
from .models import C_User, Staffs, Courses, Subjects, Students, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult
...
def staff_profile_update(request):
    if request.method != "POST":
        ...
        try:
            ...
            staff = Staffs.objects.get(admin=C_User.id)
